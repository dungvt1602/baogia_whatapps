...
type Preview = { batch: { id: string; code: string; recipientCount: number; status: string }; channel: { name: string; type: string } | null; template: { id: string; name: string }; sample: string; recipients: Recipient[] };
